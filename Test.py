...
&%%#/#&%%(/**/*/%#%&&&@@@&&&&&&&%%%(*****/(((/*///
\033[1;97m--------------------------------------------------
\033[1;93m➤\033[1;97m Author   : Marwat-Tricks
\033[1;93m➤\033[1;97m Github   : https://github.com/marwattricks398
\033[1;93m➤\033[1;97m Fb Id  : https://www.facebook.com/profile.php?id=100042965112748
\033[1;97m--------------------------------------------------
"""
...
def tech_abm():
    ...
    if username =="Marwat":
        ...
        if passwordss =="Tricks":
            os.system("clear")
            print logo
            logging()
            os.system("clear")
            print logo 
            print ("\033[1;97m[+]\033[1;92m Username : Shnato\033[1;92m (Correct)")
            print ("\033[1;97m[+]\033[1;92m Password : Ahmed\033[1;92m (Correct)")
	    print("\033[1;97m--------------------------------------------------")
            time.sleep(1)
            print('')
